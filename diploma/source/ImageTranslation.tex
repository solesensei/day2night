...
\section{Предметная область}
	\subsection{Обучение с учителем}
		\textbf{Обучение с учителем} (англ. \textit{supervised learning}) -- способ машинного обучения, в ходе которого входные объекты соотносятся с выходными до начала обучения.
		Обучение происходит на заготовленных парах объектов. Задача метода -- построить функцию внутренней зависимости между примерами, которая затем будет отображать входные изображения желаемым образом. 
...
\section{Постановка задачи}
	...
	\subsection{Формальная постановка задачи}
		...
		\subsubsection*{Вход}
			...
			\begin{itemize}
				\item \(X_{1}\) -- \textit{домен с набором изображений первого типа}
				\item \(X_{2}\) -- \textit{домен с набором изображений второго типа}
			\end{itemize}
